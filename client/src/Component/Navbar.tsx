      ...
      <span className="navbar-toggler-icon"></span>
          ...
          <div className="collapse navbar-collapse white" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ">
              ...
              <li className="nav-item">
                <Link className="white nav-link" to="/about">About</Link>
              </li>
            </ul>
          ...
          <div className={`btn-group dropstart `}>
              ...
              <ul className="dropdown-menu">
                <li><img style={{ height: "43px", marginLeft: "5px" }} src="./profilePicture.png" alt="" srcSet="" /> <span style={{ marginLeft: "5px" }}>Nikhil Gehlot</span></li>
